...
export default function UserPage() {
  ...
  if (loading) return <div style={{ fontSize: '1.2rem', fontWeight: 600 }}>Loading collection...</div>;

  return (
    <div>
      <h1 className="page-title">Discover <span>Knowledge</span></h1>
      ...
      <div className="book-grid">
        {books.map((book, i) => (
          <div key={book.book_id} className="book-card" style={{ animationDelay: `${i * 0.1}s` }}>
            ...
            <div className="book-footer">
              <span className="book-cost">${book.book_cost ? book.book_cost.toFixed(2) : '0.00'}</span>
        ...
        {books.length === 0 && (
          <div style={{ gridColumn: '1 / -1', textAlign: 'center', padding: '3rem', color: '#64748b', fontSize: '1.2rem' }}>
